 ...
 */
public class AutomaticStringEnumTypeConverterTest {

    private TypeConverter<String, Enum> enumTypeConverter;
    ...
    public void setup() throws Exception {
        ...
        enumTypeConverter = new AutomaticStringEnumTypeConverter();
